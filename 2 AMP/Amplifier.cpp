...
void Amplifier::init(unsigned int digital_volume, unsigned int analog_gain, unsigned int Select_Fsw, unsigned int I2S_Format)  {
  ...
  pinMode(3, OUTPUT); //SDB
  digitalWrite(3, HIGH); //SDB_HIGH
  pinMode(4, OUTPUT); //SDB
  digitalWrite(4, HIGH); //SDB_HIGH

  // Reset registers
  writeReg8(TAS5825M_ADDRESS, RESET_CTRL, B00000000);
  writeReg8(TAS5825M_ADDRESS2, RESET_CTRL, B00000000);
  //Book
  writeReg8(TAS5825M_ADDRESS, Book, B00000000);
  writeReg8(TAS5825M_ADDRESS2, Book, B00000000);
  ///////////////////////////////////////////////////////////////
  // Configure each device GPIOx as phase sync input usage by registers GPIO_CTRL
  // MAY NEED TO CHANGE THIS TO OUTPUT
  writeReg8(TAS5825M_ADDRESS, GPIO_CTRL, B00000111);
  //  writeReg8(TAS5825M_ADDRESS2, GPIO_CTRL, B00000000);///

  // MAY NEED TO change to 000 try each 0,1
  writeReg8(TAS5825M_ADDRESS, GPIO_OUT, B00000111);

  // try each 0,1
  writeReg8(TAS5825M_ADDRESS, SDOUT_SEL, B00000000);//B00000001:SDOUT is the DSP input,bB00000000:SDOUT is the DSP output

  // set GPIO2 as Serial audio interface data output (SDOUT)
  writeReg8(TAS5825M_ADDRESS, GPIO2_SEL, B00001001);
  // writeReg8(TAS5825M_ADDRESS2, GPIO2_SEL, B00001001);//

  // and GPIO_INPUT_SEL
//  writeReg8(TAS5825M_ADDRESS, GPIO_INPUT_SEL, B00110000);
  //  writeReg8(TAS5825M_ADDRESS2, GPIO_INPUT_SEL, B00000000);

  // Select different phase for each device and enable phase synchronization by register PHASE_CTRL
  writeReg8(TAS5825M_ADDRESS, PHASE_CTRL, B00000010);
  writeReg8(TAS5825M_ADDRESS2, PHASE_CTRL, B00000110);
  ...
  writeReg8(TAS5825M_ADDRESS2, DIG_VOL, data); //B00110000 defualt

  //Play mode
  writeReg8(TAS5825M_ADDRESS, DEVICE_CTRL_2, B00000011);
  //  writeReg8(TAS5825M_ADDRESS, POWER_STATE, B00000011);
  writeReg8(TAS5825M_ADDRESS2, DEVICE_CTRL_2, B00000011);
  //  writeReg8(TAS5825M_ADDRESS2, POWER_STATE, B00000011);
  ...
  writeReg8(TAS5825M_ADDRESS2, AGAIN, data); //=15 dB, B00011111=15.5 dB
  ...
  writeReg8(TAS5825M_ADDRESS2, SAP_CTRL1, data); //B00000000 =16bit, B00000010 =24bit, B00000011 =32bit
  //GPIO 0,1,2 is output
  //  writeReg8(TAS5825M_ADDRESS, GPIO_CTRL, B00000111);
  //  writeReg8(TAS5825M_ADDRESS2, GPIO_CTRL, B00000000);
  //  //GPIO 0 = Clock invalid flag (clock error or clock missing)
  //  writeReg8(TAS5825M_ADDRESS, GPIO0_SEL, B00000110);
  //  writeReg8(TAS5825M_ADDRESS2, GPIO0_SEL, B00000110);
  //  //GPIO 1 = Auto Mute
  //  writeReg8(TAS5825M_ADDRESS, GPIO1_SEL, B00000011);
  //  writeReg8(TAS5825M_ADDRESS2, GPIO1_SEL, B00000011);
  ...
  //
  //
  //  writeReg8(TAS5825M_ADDRESS2, GPIO2_SEL, B00000010);
  ...
  writeReg8(TAS5825M_ADDRESS2, FAULT_CLEAR, B10000000);
...
void Amplifier::sleepBtnWake() {
  ...
  writeReg8(TAS5825M_ADDRESS2, DEVICE_CTRL_2, B00001011);
  interrupts ();
  delay(500);
}
//////////////////////////////////////////////////////////////
...
int Amplifier::getCHAN_FAULT2() {
  byte data = readReg8(TAS5825M_ADDRESS2, CHAN_FAULT);
  return data;
}
...
int Amplifier::getFS_MON2() {
  byte data = readReg8(TAS5825M_ADDRESS2, FS_MON);
  return data;
}
...
int Amplifier::getGLOBAL_FAULT11() {
  byte data = readReg8(TAS5825M_ADDRESS2, GLOBAL_FAULT1);
  return data;
}

int Amplifier::getGLOBAL_FAULT22() {
  byte data = readReg8(TAS5825M_ADDRESS2, GLOBAL_FAULT2);
  return data;
}
...
int Amplifier::getPOWER_STATE2() {
  byte data = readReg8(TAS5825M_ADDRESS2, POWER_STATE);
  return data;
}
...
int Amplifier::getCLKDET_STATUS2() {
  byte data = readReg8(TAS5825M_ADDRESS2, CLKDET_STATUS);
  return data;
}
...
int Amplifier::getDEVICE_CTRL_22() {
  byte data = readReg8(TAS5825M_ADDRESS2, DEVICE_CTRL_2);
  return data;
}
