...
#define TAS5825M_ADDRESS                  0x4C // Please check datasheet ti find the correct ADDRS, Try 0x4c in case 
#define TAS5825M_ADDRESS2                 0x4E // Please check datasheet ti find the correct ADDRS, Try 0x4e in case 

//0x4e is the second amp which is not working
...
class Amplifier  {
  ...
  public:
    ...
    int getGLOBAL_FAULT11();
    int getGLOBAL_FAULT22();
    int getWARNING();
    int getFS_MON();
    int getFS_MON2();
    int getPVDD_ADC();
